...
-- Tiempo de generación: 13-03-2026 a las 15:33:44
...
CREATE TABLE `inscripciones` (
  ...
  `estado` enum('activo','aprobado','reprobado') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `participantes` (
  ...
  `apellidos_materno` varchar(150) DEFAULT NULL,
...
('dywWLZCpApiFwgE7oiFvlQPwV3P3yuvg3yD2XspG', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '', 1773411905);
...
ALTER TABLE `participantes`
  ...
  ADD UNIQUE KEY `carnet` (`carnet`,`complemento`);
...
--
ALTER TABLE `horarios_curso`
  ADD CONSTRAINT `horarios_curso_ibfk_1` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id_curso`);
...
ALTER TABLE `inscripciones`
  ...
  ADD CONSTRAINT `inscripciones_ibfk_2` FOREIGN KEY (`id_horario`) REFERENCES `horarios_curso` (`id_horario`);
COMMIT;
